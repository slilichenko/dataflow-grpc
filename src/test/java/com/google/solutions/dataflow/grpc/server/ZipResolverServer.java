...
package com.google.solutions.dataflow.grpc.server;

import com.google.solutions.dataflow.grpc.ResolveResponse;
import com.google.solutions.dataflow.grpc.ResolveResponse.Outcome;
...
public class ZipResolverServer {

  private static final Logger logger =
      Logger.getLogger(ZipResolverServer.class.getName());

  private Server server;
  private Map<String,ResolvedAddress> database = new ConcurrentHashMap<>();

  public static void main(String[] args) throws InterruptedException, IOException {
    ZipResolverServer zipResolverServer = new ZipResolverServer();
    zipResolverServer.runWithoutWaitingForTermination(args);
